...
class Gestor_empleado {
    ...
    mostrar_empleado() {
        ...
        eliminar_boton.forEach(button => {
            button.addEventListener('click', () => {
                const indice = button.getAttribute('data-indez');
    ...
    editar_empleado(indice) {
        ...
        // Ahora vamos a establecer los valores de los campos de entrada del formulario con el nombre del empleado el cual se busca editar
